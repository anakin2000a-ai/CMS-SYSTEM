    ...
    public function delete($id){
     ...
     public function update(Request $request, $id)
         ...
         public function ViewArticleSlug($slug){
              // Attempt to find the article by its slug
            ...
            if (!$article) {
                return response()->json([
                    ...
                    'message' => 'The article with the given slug does not exist.'  // More details about the error
                ], 404);  // Return HTTP 404 status for "Not Found"
            }

            // If the article is found, return it in the response
            return response()->json([
                'message' => 'Article retrieved successfully.',  // Success message
                'data' => $article  // The article data
            ], 200);  // Return HTTP 200 status for "OK"
